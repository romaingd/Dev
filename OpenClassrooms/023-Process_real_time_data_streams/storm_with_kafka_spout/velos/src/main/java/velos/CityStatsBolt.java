...
// As a WindowedBolt, this bolt will process sequences of tuples in `execute`
// instead of individual tuples. This enables computing stats over time frames.
// Here, we configured it with a 5 minutes tumbling window (VS sliding window).
