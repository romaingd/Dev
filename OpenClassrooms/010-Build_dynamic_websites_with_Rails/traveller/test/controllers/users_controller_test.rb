...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user" do
    assert_difference('User.count') do
      post users_url, params: { user: { name: 'bar', email: 'bar@example.com', password: 'foo', password_confirmation: 'foo' } }
    end
  ...
  test "should not create user without matching password confirmation" do
    assert_no_difference('User.count') do
      post users_url, params: { user: {name: 'bar', email: 'foo@example.com', password: 'foo', password_confirmation: 'bar' } }
    end
  ...
  test "should not create user with wrongly formatted email" do
    assert_no_difference('User.count') do
      post users_url, params: { user: {name: 'bar', email: 'fooxample.com', password: 'foo', password_confirmation: 'foo' } }
    end
